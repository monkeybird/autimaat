...
For example:
	...
	join := cmd.Bind("join", "Join the given channel", onJoin)
	join.Add("channel", "Name of the channel to join", true, cmd.RegChannel)
	join.Add("password", "Password needed to authenticate", false, cmd.RegAny)
