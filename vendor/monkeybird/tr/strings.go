...
const (
	...
	OpenWeatherCurrentWeatherText   = "%s, in %s (%s) is het %d°C, %s, luchtdruk: %d hPa, luchtvochtigheid: %d%%, wind: %.1f km/u uit %s richting, bewolking: %d%%."
	...
	OpenWeatherForecastText2        = "%s, over \x02±%d uur\x02: %d°C, %s, wind: %.1f km/h uit %s richting, bewolking: %d%%."
